...
(function() {
  ...
  function testGetName(){
    // Unit tests for lb.core.Module#getName()

    var name = 'lb.ui.stub';
    var module = new lb.core.Module(name, createStubModule);
    assert.equals( module.getName(), name,
                  "getName expected to return the name given in constructor");
  }

  function testGetSandbox(){
    // Unit tests for lb.core.Module#getSandbox()
  ...
  function testSetSandbox(){
    // Unit tests for lb.core.Module#setSandbox()
  ...
  function testSubscribe(){
    // Unit tests for lb.core.Module#subscribe()
  ...
  function testNotify(){
    // Unit tests for lb.core.Module#notify()
  ...
  function testStop(){
    // Unit tests for lb.core.Module#stop()
    ...
    module = new lb.core.Module('lb.ui.fail', createFailingModule);
    module.setSandbox(stubSandbox);
    module.start();
    logMessages = [];
    module.stop();
    ...
    module = new lb.core.Module('lb.ui.module', createStubModule);
    module.setSandbox(stubSandbox);
    module.start();
  ...
  function testGetStatus(){
    // Unit tests for lb.core.Module#isStarted()
